...
import '../fragments/provider_profile_fragment.dart';
...
class CityManagerState extends State<CityManager> {
  ...
  List<UserTypeData> hardcodedUserTypes = [
    UserTypeData(createdAt: "2290", id: 2, name: 'Type 2',updatedAt: "44r5"),
    UserTypeData(createdAt: "2390", id: 1, name: 'Type 1',updatedAt: "223e"),
    // Add more UserTypeData instances as needed
  ];
  ...
  Widget _buildTopWidget() {
    return Column(
      children: [
        ...
        16.height,
        Text("Add City Manager", style: boldTextStyle(size: 18)),
        32.height,
      ],
    );
  }
    ...
    if (formKey.currentState!.validate()) {
      ...
      if (isAcceptedTc) {
        ...
        await registerUser(request).then((userRegisterData) async {
          ...
          push(ProviderProfileFragment(), isNewTask: true, pageRouteAnimation: PageRouteAnimation.Fade);
