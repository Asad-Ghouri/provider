...
import 'package:handyman_provider_flutter/provider/AddCityManager/City%20Manager.dart';
import 'package:handyman_provider_flutter/provider/Comission/comission_screen.dart';
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Divider(height: 0, thickness: 1, indent: 15.0, endIndent: 15.0, color: context.dividerColor),
                    SettingItemWidget(
                      leading: Image.asset(commission_icon, height: 16, width: 16, color: appStore.isDarkMode ? white : gray.withOpacity(0.8)),
                      title: "Commission",
                      trailing: Icon(Icons.chevron_right, color: appStore.isDarkMode ? white : gray.withOpacity(0.8), size: 24),
                      onTap: () {
                        CommissionScreen().launch(context);
                      },
                    ),
                    Divider(height: 0, thickness: 1, indent: 15.0, endIndent: 15.0, color: context.dividerColor),
                    SettingItemWidget(
